...
export const metadata: Metadata = {
  title: 'Contact IPTVPUT - Get Support for Your IPTV Subscription',
  description: 'Contact IPTVPUT for support with your IPTV subscription. Get help via WhatsApp, email or phone for your IPTVPUT service.',
  keywords: 'contact IPTVPUT, IPTVPUT support, IPTV help, IPTVPUT customer service, IPTV contact'
}
  ...
  const contactMethods = [
    {
      ...
      description: "Get instant help with your IPTVPUT subscription",
    ...
    },
    {
      ...
      title: "Email Support",
      description: "Send us your IPTVPUT service questions",
      contact: "contact@iptvput.com",
    ...
    },
    {
      ...
      title: "Phone Support",
      description: "Call us for immediate IPTVPUT assistance",
      contact: "+44 7956 154482",
      ...
      <section className="bg-gradient-to-br from-primary-600 to-primary-800 text-white py-20">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-5xl md:text-6xl font-bold mb-6">
            Contact <span className="text-blue-300">IPTVPUT</span>
          </h1>
          <p className="text-xl md:text-2xl max-w-4xl mx-auto leading-relaxed">
            Need help with your IPTVPUT subscription? Our premium support team is here to assist 
