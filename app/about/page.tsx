...
export const metadata: Metadata = {
  title: 'About IPTVPUT - Premium IPTV Service Provider | IPTVPUT Company',
  description: 'Learn about IPTVPUT - leading premium IPTV service provider. Discover our IPTVPUT company story, mission, and why millions choose our IPTV subscription service worldwide.',
  keywords: 'about iptvput, iptvput company, iptvput service provider, premium iptv provider, iptvput history, iptv streaming company',
  openGraph: {
    title: 'About IPTVPUT - Premium IPTV Service Provider',
    description: 'Discover IPTVPUT company story and why we are the leading premium IPTV service provider worldwide.',
      ...
      <section className="bg-gradient-to-br from-primary-600 to-primary-800 text-white py-20">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-5xl md:text-6xl font-bold mb-6">
            About <span className="text-blue-300">IPTVPUT</span>
          </h1>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg mx-auto text-gray-600">
              <p className="text-xl leading-relaxed mb-8">
                IPTVPUT has been at the forefront of revolutionizing home entertainment 
              ...
              <p className="text-lg leading-relaxed mb-8">
                Our IPTVPUT platform has grown to serve over 100,000 satisfied customers worldwide, 
              ...
              <p className="text-lg leading-relaxed">
                Today, IPTVPUT stands as the premier destination for IPTV subscriptions, 
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center text-gray-800 mb-16">
            Why Choose Our IPTVPUT Service?
          </h2>
      ...
      <section className="py-20 bg-primary-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-6">
            Ready for Your Gamma IPTV Experience?
          </h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Join thousands of satisfied customers who have chosen our premium Gamma IPTV service 
